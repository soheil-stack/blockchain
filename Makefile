...
up:
	CONSENSUS=poa BENEFICIARY=miner1 HOST=0.0.0.0:8080 DB_PATH=zblock/miner1 go run cmd/node/main.go

up2:
	CONSENSUS=poa BENEFICIARY=miner2 HOST=0.0.0.0:8081 DB_PATH=zblock/miner2 go run cmd/node/main.go
